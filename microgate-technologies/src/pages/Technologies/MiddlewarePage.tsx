      ...
      >
        <div className="space-y-3">
          ...
          <div className="bg-gradient-to-r from-[#36B5A0]/10 to-[#0A6B7E]/10 rounded-2xl p-4 py-5 ">
            ...
            <div className="mt-8">
              <h4 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 text-center">
                ...
                {middlewareTechnologies.map((tech, index) => (
                  <div key={index} className="bg-white rounded-xl p-4 shadow-md border border-gray-200 hover:border-[#36B5A0] transition-all duration-300">
                    <div className="flex flex-col items-center text-center h-full">
                      ...
                      <h5 className="text-med md:text-lg font-semibold text-gray-800 mb-2">{tech.title}</h5>
